...
class SvgUri extends Component {
  ...
  static getDerivedStateFromProps = ( props, state ) => {
    ...
    if ( props.source !== state.source ) {
      ...
      if ( source.uri !== oldSource.uri ) {
        nextState.source = props.source;
        this.fetchSVGData( source.uri );
      }
    }

    if ( props.svgXmlData !== state.svgXmlData ) {
      nextState.svgXmlData = props.svgXmlData;
    }

    if ( props.fill !== state.fill ) {
      nextState.fill = props.fill;
    }
  ...
  constructor( props ) {
    ...
    this.state = { fill: props.fill, svgXmlData: props.svgXmlData, source: props.source };
